    ...
    async def stream_chat(self, prompt: str):
        ...
        try:
            chat_prompt = PromptTemplate.from_template(
                ...
                3. 만약, 내용과 관계 있는 질문이지만, 주어진 문맥(context)에서 답을 찾을 수 없다면, 내부 지식(internal knowledge)을 사용하여 답변을 생성하세요.
                4. 내부 지식으로 답변할 경우 "주어진 정보에서 질문에 대한 답변을 찾을 수 없습니다."라고 말하지말고, 바로 답변하세요.
                5. 내부 지식은 검토 후 답변하세요.
