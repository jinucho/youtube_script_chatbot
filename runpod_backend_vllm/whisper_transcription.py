...
class WhisperTranscriptionService:
    ...
    def download_audio_parallel(
        self, url: str, temp_dir: str, num_chunks: int = 10
    ) -> str:
        session = self.create_session()
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            for i in range(total_chunks):
                ...
                self.split_audio(
                    ...
                    chunk_wav_path,
                    i * chunk_duration,
                    min(chunk_duration, total_duration - i * chunk_duration),
                )

                segments, _ = self.pipeline.transcribe(chunk_wav_path)
    ...
    def split_audio(
        self, input_path: str, output_path: str, start_time: int, duration: int
    ) -> str:
